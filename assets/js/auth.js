(function () {
  ...
  function getRedirectTo() {
    const siteUrl =
      window.SITE_URL ||
      document.body?.getAttribute("data-site-url") ||
      getMeta("site-url") ||
      window.location.origin;

    return `${siteUrl}/dashboard.html`;
  }
  ...
  async function fillAuthUserUI() {
    try {
      ...
      const fullNameEls = document.querySelectorAll("[data-auth='full_name']");
      const emailEls = document.querySelectorAll("[data-auth='email']");
      const referralEls = document.querySelectorAll("[data-auth='referral_code']");
      const roleEls = document.querySelectorAll("[data-auth='role']");
